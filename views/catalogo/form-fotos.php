  ...
  <div class="container mt-4">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="card mt-4">
          <div class="card-body">
            <h1 class="text-center">Agregar Imagenes a la galeria:</h1>
            <form autocomplete="off" id="form-imagen">
              <div class="mb-3">
                <label for="imagen" class="form-label">Imagenes:</label>
                <input type="file" class="form-control" id="imagen" accept=".png,.jpg,.png" required>
              </div>
              <button type="submit" class="btn btn-primary" id="guardar-imagen">Agregar Imagen</button>
            </form>
          </div>
        </div>
      </div>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", () => {
      ...
      function agregarImagen() {
        ...
        parametros.append("operacion", "agregarImagen");
      ...
      //  Detener el SUBMIT
      $("#form-imagen").addEventListener("submit", (event) => {
